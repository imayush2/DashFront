  ...
  return (
    <Card border="light" className="shadow-sm">
      <Card.Header className="border-bottom border-light">
        <h5 className="mb-0">Diseases track</h5>
      </Card.Header>
      <Card.Body>
        <Progress
          title="Heart"
          ...
          percentage={34}
        />
        <Progress title="Brain" color="danger" icon={faBrain} percentage={60} />
        <Progress
          title="Liver"
          color="tertiary"
          icon={faVuejs}
          percentage={45}
        />
        <Progress title="Ortho" color="info" icon={faBandAid} percentage={35} />
        <Progress
          last
          title="Skin"
          color="purple"
